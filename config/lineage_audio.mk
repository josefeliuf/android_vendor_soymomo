...
ALARM_PATH := vendor/soymomo/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/soymomo/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/soymomo/prebuilt/common/media/audio/ringtones
